  ...
  return (
    <ul className="flex flex-col col-span-2 space-y-6">
      {comments.map((comment) => {
        // NOTE: For some reason, when initialComments is generated using a <Link>
        // navigation, comment.post will be missing on all the initial comments.
        ...
        return (
          <div key={comment.id} className="rounded-b-lg bg-white shadow">
            <Link
              ...
              className="grid grid-cols-[2rem_1fr] px-3 py-3 bg-gray-50 border border-gray-50 hover:border-gray-700"
            >
            ...
            <div className="grid grid-cols-[2rem_1fr] px-3 pt-3 pb-3 rounded-b-lg border border-white hover:border-gray-700">
              <div></div>
              <div>
